                        ...
                        {!activeDefinition ? (
                            ...
                            <div className="space-y-4">
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        {activeDefinition.conditions.map(
                                            (condition) => (
                                                <SelectItem
                                                    key={condition.value}
            ...
            {filters.length > 0 && (
                <div className="flex flex-wrap items-center gap-2">
                    <Select
                        ...
                        disabled={disabled}
                        onValueChange={(value) =>
                            updateAggregator(value as "and" | "or")
                        }
                    >
                        <SelectTrigger
                            className="h-10 w-24"
                            aria-label={aggregatorAriaLabel}
                        >
                            <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
