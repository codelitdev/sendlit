...
<div class="container">
  <div class="left-pane">
    <div class="logo-area">
      ...
      <span class="logo-text">SendLit</span>
    </div>

    <div class="quote-container">
      <blockquote class="quote">
        "Broadcasts, sequences and automation — one OAuth-protected API for all of your transactional and marketing email."
      </blockquote>
    </div>

    <div class="left-footer">SendLit.</div>
  </div>
