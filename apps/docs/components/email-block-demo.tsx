...
const allSubscribers: SubscriberListItem[] = [
  { id: "contact_1", name: "Ava Whitfield", email: "ava.whitfield@example.com" },
  { id: "contact_2", email: "noah.carter@example.com" },
  { id: "contact_3", email: "mia.johnson@example.com" },
  { id: "contact_4", name: "Isabelle Moreau", email: "isabelle.moreau@example.com" },
  { id: "contact_5", name: "Olivia Bennett", email: "olivia.bennett@example.com" },
  { id: "contact_6", name: "Ethan Brooks", email: "ethan.brooks@example.com" },
  { id: "contact_7", email: "sophia.reyes@example.com" },
  { id: "contact_8", name: "Lucas Fischer", email: "lucas.fischer@example.com" },
  ...
  { id: "contact_12", name: "Priya Sharma", email: "priya.sharma@example.com" },
  ...
  { id: "contact_18", name: "Liam O'Brien", email: "liam.obrien@example.com" },
  { id: "contact_19", email: "zoe.martin@example.com" },
  { id: "contact_20", name: "Sofia Torres", email: "sofia.torres@example.com" },
