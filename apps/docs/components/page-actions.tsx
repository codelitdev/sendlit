        ...
        return [
            {
                ...
                href: githubUrl,
                icon: <BrandIcon title="GitHub" path={githubPath} />,
            },
            {
            ...
            },
            {
                ...
                icon: <BrandIcon title="OpenAI" path={openAIPath} />,
            },
            {
                ...
                icon: <BrandIcon title="Anthropic" path={claudePath} />,
            },
            {
                ...
                icon: <BrandIcon title="Cursor" path={cursorPath} />,
            },
        ];
